...
export const snippets: SnippetManifestItem[] = [
  {
    ...
    iconKey: "Variable",
    dataPath: "variables/boolean.json",
    fileType: "json",
  },
  {
    id: "variables-2",
    ...
    iconKey: "Variable",
    dataPath: "variables/integer.json",
    fileType: "json",
  },
  {
    id: "variables-4",
  ...
  },
  {
    ...
    iconKey: "Variable",
    dataPath: "variables/string.json",
    fileType: "json",
  },
  {
    id: "variables-6",
    ...
    iconKey: "Variable",
    dataPath: "variables/object.json",
    fileType: "json",
  },
  {
    id: "variables-7",
  ...
  },
  {
    ...
    iconKey: "Errorhandling",
    dataPath: "errorHandling/basicErrorHandling.json",
    fileType: "json",
  },
  {
    id: "error-2",
    categoryId: "error",
    name: "Basic Error Handler incl. Terminate",
    iconKey: "Errorhandling",
  ...
  },
  {
    ...
    iconKey: "Errorhandling",
    dataPath: "errorHandling/basicErrorHandlingMail.json",
    fileType: "json",
  },
  {
    id: "error-4",
  ...
  },
  {
    ...
    iconKey: "Sharepoint",
    dataPath: "sharepoint/requestManagerApproval.json",
    fileType: "json",
  },
  {
    id: "sharepoint-2",
    ...
    iconKey: "Sharepoint",
    dataPath: "sharepoint/getFilesByNameAndNoFolder.json",
    fileType: "json",
  },
  {
    id: "sharepoint-3",
    ...
    iconKey: "Sharepoint",
    dataPath: "sharepoint/getFilesByNameAndNoFolder.txt",
    fileType: "txt",
  },
  {
    id: "sharepoint-4",
    ...
    iconKey: "Sharepoint",
    dataPath: "sharepoint/getFolderByName.json",
    fileType: "json",
  },
  {
    id: "sharepoint-5",
    ...
    iconKey: "Sharepoint",
    dataPath: "sharepoint/getFolderByName.txt",
    fileType: "txt",
  },
  {
    id: "sharepoint-6",
  ...
  },
  {
    id: "sharepoint-8",
    categoryId: "sharepoint",
    name: "Batch create items in SP List",
    iconKey: "Sharepoint",
    dataPath: "sharepoint/batchCreateItemsInSharepointList.json",
    fileType: "json",
  },
  {
    id: "sharepoint-9",
    categoryId: "sharepoint",
    name: "Batch update items in SP List",
    iconKey: "Sharepoint",
    dataPath: "sharepoint/batchUpdateItemsInSharepointList.json",
    fileType: "json",
  },
  {
    id: "sharepoint-10",
    categoryId: "sharepoint",
    name: "Batch delete items in SP List",
    iconKey: "Sharepoint",
    dataPath: "sharepoint/batchDeleteItemsInSharepointList.json",
    fileType: "json",
  },
  {
    id: "excelonline-1",
  ...
  {
    id: "dataverse-1",
    categoryId: "dataverse",
    name: "Send picture embedded via mail",
    iconKey: "Dataverse",
    dataPath: "dataverse/sendPicturesEmbeddedViaMail.json",
    fileType: "json",
  },
  {
    id: "outlook-1",
