import { useCopyJsonExpressionSettings } from "../../hooks/useCopyJsonExpressionSettings";
...
export default function CopyJsonExpressionSettingsRow() {
  const { isActive, toggleActive } = useCopyJsonExpressionSettings();
